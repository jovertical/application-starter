...
<Auth title="Verify email">
    <div class="space-y-6">
        ...
        <form class="flex items-center justify-center" on:submit|preventDefault="{handleLogout}">
            <button class="font-medium text-indigo-600 hover:text-indigo-500 text-sm" type="submit">
                Logout
            </button>
        </form>
